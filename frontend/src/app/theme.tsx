...
const themePalettes: Record<"light" | "dark", Record<ThemeAccent, ThemePalette>> = {
  ...
  dark: {
    green: {
      primary: "128 26% 22%",
      primaryForeground: "204 14% 93%",
      secondary: "128 24% 24%",
      secondaryForeground: "204 14% 93%",
      tertiary: "30 28% 27%",
      tertiaryForeground: "204 14% 93%",
      neutral: "210 18% 30%",
      neutralForeground: "204 14% 93%",
      surface: "207 28% 14%",
      surfaceForeground: "204 14% 93%",
      accent: "91 40% 52%",
      accentForeground: "205 46% 10%",
    },
    blue: {
      primary: "202 84% 68%",
