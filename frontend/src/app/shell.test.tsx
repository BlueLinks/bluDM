...
describe("useThemeMode", () => {
  ...
  it("persists the selected accent and applies matching theme variables", async () => {
    ...
    await waitFor(() => {
      ...
      expect(document.documentElement.style.getPropertyValue("--surface")).toContain("205 36% 94%");
  ...
  it.each([
    ["light", "green", "148 48% 26%", "102 24% 35%", "30 34% 34%", "40 35% 93%", "132 14% 11%"],
    ["light", "blue", "212 78% 38%", "184 62% 31%", "158 44% 30%", "205 36% 94%", "132 14% 11%"],
    ["light", "pink", "330 58% 39%", "315 32% 38%", "274 45% 36%", "42 35% 93%", "132 14% 11%"],
    ["light", "red", "8 66% 37%", "24 74% 40%", "350 46% 31%", "39 35% 93%", "132 14% 11%"],
    ["dark", "green", "144 52% 61%", "95 35% 62%", "34 44% 64%", "220 12% 18%", "204 36% 94%"],
